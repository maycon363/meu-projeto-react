...
import Avaliadas from './pages/series/Avaliadas';
import Populares from './pages/filmes/Populares';
import ProxEstreias from './pages/filmes/ProxEstreias';
import LinearProgressScroll from './components/LinearProgress';

function App() {
  return (
    <div className="fundo">
       <LinearProgressScroll />
          ...
          <Menu />
            <main className="flex-grow">
              <Routes>   
                ...
                <Route path="/filmes/populares" element={<Populares/>}></Route>
                <Route path="/filmes/Prox-estreias" element={<ProxEstreias/>}></Route>
                ...
                <Route path="/series/bem-avaliadas" element={<Avaliadas/>}></Route>              
              </Routes>
            </main>  
          <Footer />
        <ScrollToTopButton />
